...
<section id="comments">
	<?php do_action('kitecomwp_before_comments_count'); ?>
	<h2>
	...
	<?php do_action('kitecomwp_after_comments_count'); ?>
	...
	<?php do_action('kitecomwp_before_comments_list'); ?>
	<ol>
		<?php wp_list_comments(array( 'callback' => 'kitecom_comment_template', 'style' => 'ol')); ?>	
	</ol>
	<?php do_action('kitecomwp_after_comments_list'); ?>
	...
	<?php endif; ?>
	<?php do_action('kitecomwp_before_comments_form'); ?>
	<?php comment_form(); ?>
	<?php do_action('kitecomwp_after_comments_form'); ?>
</section>
