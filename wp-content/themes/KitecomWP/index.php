...
?>		
	...
	<?php if(get_option($tpl->name . '_template_homepage_mainbody', 'N') == 'N') : ?>
		<?php do_action('kitecomwp_before_mainbody'); ?>
		
		<?php if ( have_posts() ) : ?>		
			<section id="gk-mainbody">
				<?php do_action('kitecomwp_before_loop'); ?>
				...
				<?php do_action('kitecomwp_after_loop'); ?>
			</section>
		<?php else : ?>
			<section id="gk-mainbody">
		...
		<?php endif; ?>
		<?php do_action('kitecomwp_after_mainbody'); ?>
	<?php else: ?>
