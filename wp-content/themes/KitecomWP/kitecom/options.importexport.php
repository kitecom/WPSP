...
ob_start();	
function kitecom_importexport_options() {
	// getting access to the template and database global object. 
	global $tpl;
	global $wpdb;
	wp_register_style('gk-import-export-css', kitecom_file_uri('css/back-end/importexport.css'));
...
?>
	<div class="gkWrap wrap">
		...
		<div class="gkImport">
			...
			<?php
				if (isset($_FILES['import']) && check_admin_referer('kitecom_importexport')) {
		...
		?>
			...
			<form method='post' enctype='multipart/form-data'>
				<p class="submit">
					<?php wp_nonce_field('kitecom_importexport'); ?>
...
<?php 
  	} elseif (check_admin_referer('kitecom_importexport')) {
