...
if(get_option($tpl->name . '_shortcodes1_state', 'Y') == 'Y') {
	 ...
	 *
	 **/
	if(!function_exists('kitecom_ts_warning')) {
		// Usage:
		// [warning]text[/warning]
		function kitecom_ts_warning($atts, $content) {   
			// return the url
		    return '<p class="gk-warning">'.$content.'</p>';  
		} 
		// add the shortcode to system
		add_shortcode('warning', 'kitecom_ts_warning');
	} 
	 ...
	 *
	 **/
	if(!function_exists('kitecom_ts_info')) {
		// Usage:
		// [info]text[/info]
		function kitecom_ts_info($atts, $content) {   
			// return the url
		    return '<p class="gk-info">'.$content.'</p>';  
		} 
		// add the shortcode to system
		add_shortcode('info', 'kitecom_ts_info');
	} 
	 ...
	 *
	 **/
	if(!function_exists('kitecom_ts_notice')) {
		// Usage:
		// [notice]text[/notice]
		function kitecom_ts_notice($atts, $content) {   
			// return the url
		    return '<p class="gk-notice">'.$content.'</p>';  
		} 
		// add the shortcode to system
		add_shortcode('notice', 'kitecom_ts_notice');
	} 
	 ...
	 *
	 **/
	if(!function_exists('kitecom_ts_error')) {
		// Usage:
		// [error]text[/error]
		function kitecom_ts_error($atts, $content) {   
			// return the url
		    return '<p class="gk-error">'.$content.'</p>';  
		} 
		// add the shortcode to system
		add_shortcode('error', 'kitecom_ts_error');
	} 
	 ...
	 *
	 **/
	if(!function_exists('kitecom_ts_label')) {
		// Usage:
		// [label]text[/label]
		// [label style="2"]text[/label]
		function kitecom_ts_label($atts, $content) {   
		...
		// add the shortcode to system
		add_shortcode('label', 'kitecom_ts_label');
	}
	 ...
	 *
	 **/
	if(!function_exists('kitecom_ts_badge')) {
		// Usage:
		// [badge]text[/badge]
		// [badge style="2"]text[/badge]
		function kitecom_ts_badge($atts, $content) {   
			// get the optional style value
			extract(shortcode_atts( array('style' => '1'), $atts));
			// return the url
		...
		// add the shortcode to system
		add_shortcode('badge', 'kitecom_ts_badge');
	}
	 ...
	 *
	 **/
	if(!function_exists('kitecom_ts_code')) {
		// Usage:
		// [code]text[/code]
		// [code style="2"]text[/code]
		function kitecom_ts_code($atts, $content) {   
			// get the optional style value
			extract(shortcode_atts( array('style' => '1'), $atts));
			// return the element
		...
		// add the shortcode to system
		add_shortcode('code', 'kitecom_ts_code');
	} 
	 ...
	 *
	 **/
	if(!function_exists('kitecom_ts_text_block')) {
		// Usage:
		// [textblock]text[/textblock]
		// [textblock style="2"]text[/textblock]
		function kitecom_ts_text_block($atts, $content) {   
			// get the optional style value
			extract(shortcode_atts( array('style' => '1'), $atts));
			// return the url
		...
		// add the shortcode to system
		add_shortcode('textblock', 'kitecom_ts_text_block');
	}  
	 ...
	 *
	 **/
	if(!function_exists('kitecom_ts_quote')) {
		// Usage:
		// [quote author="John Doe"]text[/quote]
		// [quote style="2" author="John Doe"]text[/quote]
		function kitecom_ts_quote($atts, $content) {   
			// get the optional style value
		...
		// add the shortcode to system
		add_shortcode('quote', 'kitecom_ts_quote');
	}
	 ...
	 *
	 **/
	if(!function_exists('kitecom_ts_olist')) {
		// Usage:
		// [olist]
		// item1
		// item2
		...
		// item2
		// [/olist]
		function kitecom_ts_olist($atts, $content) {   
			// get the optional style value
			extract(shortcode_atts( array('style' => '1'), $atts));
			// generate output
		...
		// add the shortcode to system
		add_shortcode('olist', 'kitecom_ts_olist');
	}
	 ...
	 *
	 **/
	if(!function_exists('kitecom_ts_ulist')) {
		// Usage:
		// [ulist]
		// item1
		// item2
		...
		// item2
		// [/ulist]
		function kitecom_ts_ulist($atts, $content) {   
			// get the optional style value
			extract(shortcode_atts( array('style' => '1'), $atts));
			// generate output
		...
		// add the shortcode to system
		add_shortcode('ulist', 'kitecom_ts_ulist');
	}
	...
	if(!function_exists('kitecom_ts_numblock')) {
		...
		// add the shortcode to system
		add_shortcode('numblock', 'kitecom_ts_numblock');
	}
	 ...
	 *
	 **/
	if(!function_exists('kitecom_ts_columns')) {
		// Usage:
		// [columns]
		...
		// [column]Content for the third column[/column]
		// [/columns]
		function kitecom_ts_columns($atts, $content) {   
		...
		// add the shortcode to system
		add_shortcode('columns', 'kitecom_ts_columns');
	}
	 ...
	 *
	 **/
	if(!function_exists('kitecom_ts_button')) {
		// Usage:
		// [button]text[/button]
		// [button style="2"]text[/button]
		// with URL
		// [button style="2" url="http://kitecommunication.com"]text[/button]
		function kitecom_ts_button($atts, $content) {   
			// get the optional style value
		...
		// add the shortcode to system
		add_shortcode('button', 'kitecom_ts_button');
	}
	 ...
	 *
	 **/
	if(!function_exists('kitecom_ts_legend')) {
		// Usage:
		// [legend title="Title"]text[/legend]
		// [legend title="Title" style="2"]text[/legend]
		function kitecom_ts_legend($atts, $content) {   
			// get the optional style value
		...
		// add the shortcode to system
		add_shortcode('legend', 'kitecom_ts_legend');
	}
	 ...
	 *
	 **/
	if(!function_exists('kitecom_ts_float')) {
		// Usage:
		// [floated]text[/floated]
		// [floated align="left"]text[/floated]
		function kitecom_ts_float($atts, $content) {   
			// get the optional style value
		...
		// add the shortcode to system
		add_shortcode('floated', 'kitecom_ts_float');
	}
	 ...
	 *
	 **/
	 if(!function_exists('kitecom_ts_rss')) {
	 	// Usage:
	 	// [rss href="url"]text[/rss]
	 	function kitecom_ts_rss($atts, $content) {   
	 		// get the optional style value
	 		extract(shortcode_atts( array('href' => ''), $atts));
	 		// return the url
	 	    return '<a class="gk-rss" href="' . $href . '"><i class="icon-bullhorn"></i></a>';  
	 	} 
	 	// add the shortcode to system
	 	add_shortcode('rss', 'kitecom_ts_rss');
	 }
	 ...
	 *
	 **/
	if(!function_exists('kitecom_ts_raw')) {
		// Usage:
		// [raw]text[/raw]
		// [raw style="1"]text[/raw]
		function kitecom_ts_raw($atts, $content) {   
			// get the optional style value
			extract(shortcode_atts( array('style' => '1'), $atts));
			// return the url
		...
		// add the shortcode to system
		add_shortcode('raw', 'kitecom_ts_raw');
	}
	 ...
	 *
	 **/
	if(!function_exists('kitecom_ts_pageurl')) {
		// Usage:
		// [pageurl]
		function kitecom_ts_pageurl( $atts ){
			// return the url
			return home_url();
		}
		add_shortcode( 'pageurl', 'kitecom_ts_pageurl' );
	}
	 ...
	 *
	 **/
	if(!function_exists('kitecom_ts_themeurl')) {
		// Usage:
		// [themeurl]
		function kitecom_ts_themeurl( $atts ){
			// return the theme directory url
			return kitecom_file_uri(false);
		}
		add_shortcode( 'themeurl', 'kitecom_ts_themeurl' );
	}
}
...
if(get_option($tpl->name . '_shortcodes2_state', 'Y') == 'Y') {  	  
	...
	if(!function_exists('kitecom_ies_toggled')) {
		...
		// add the shortcode to system
		add_shortcode('toggle', 'kitecom_ies_toggled');
	}
	// tooltips
	if(!function_exists('kitecom_ies_tooltips')) {
		// Usage:
		// [tip label="Label"]Text of the tooltip[/tip]
		// [tip label="Label" style="1"]Text of the tooltip[/tip]
		// [tip label="Label" style="1" href="http://kitecommunication.com"]Text of the tooltip[/tip]
		function kitecom_ies_tooltips($atts, $content) {   
			// get the optional style value
		...
		// add the shortcode to system
		add_shortcode('tip', 'kitecom_ies_tooltips');
	} 
	// google docs viewer
	if(!function_exists('kitecom_ies_pdflink')) {
		// Usage
		// [pdf url="URL"]Text[/pdf]
		function kitecom_ies_pdf($atts, $content) {   
			// get the params
		...
		// add the shortcode to system
		add_shortcode('pdf', 'kitecom_ies_pdf');
	} 
	// private notes
	if(!function_exists('kitecom_ies_note')) {
		// Usage:
		// [note]Your private note[/note]
		function kitecom_ies_note( $atts, $content = null ) {
		...
		add_shortcode( 'note', 'kitecom_ies_note' );
	}
	// obfuscate an email address
	if(!function_exists('kitecom_ies_mail_obfuscate')) {
		// Usage
		// [mail]mail.to@obfuscate.com[mail]
		function kitecom_ies_mail_obfuscate( $atts , $content = null ) {
		    $encoded_email = '';
		...
		add_shortcode('mail', 'kitecom_ies_mail_obfuscate');
	}
	// content for registered users
	if(!function_exists('kitecom_ies_members_content')) {
		// Usage:
		// [members_content]Content for the members only[/members_content]
		function kitecom_ies_members_content( $atts, $content = null ) {
		...
		add_shortcode( 'members_content', 'kitecom_ies_members_content' );
	}
	// related posts
	if(!function_exists('kitecom_ies_related_posts')) {
		// Usage
		// [related]
		// [related limit="5"]
		function kitecom_ies_related_posts($atts) {
		...
		add_shortcode('related', 'kitecom_ies_related_posts');
	}  
 }
...
if(get_option($tpl->name . '_shortcodes3_state', 'Y') == 'Y') {  
	// use for the function names prefix kitecom_tss_ prefix
	 ...
	 *
	 **/
	if(!function_exists('kitecom_tss_big_header')) {
		// Usage:
		// [bigheader]Hello, <span>everyone!</span>[/bigheader]
		function kitecom_tss_big_header($atts, $content) {   
			// return the code
			return '<h1 class="gk-big-header">'.$content.'</h1>';    
		} 
		// add the shortcode to system
		add_shortcode('bigheader', 'kitecom_tss_big_header');
	}
	 ...
	 *
	 **/
	if(!function_exists('kitecom_tss_medium_header')) {
		// Usage:
		// [mediumheader]Archive page template[/mediumheader]
		function kitecom_tss_medium_header($atts, $content) {   
			// return the code
			return '<h2 class="gk-medium-header">'.$content.'</h2>';    
		} 
		// add the shortcode to system
		add_shortcode('mediumheader', 'kitecom_tss_medium_header');
	}
	 ...
	 *
	 **/
	if(!function_exists('kitecom_tss_small_header')) {
		// Usage:
		// [smallheader]I’m new and really free Wordpress 3.4 template based on the brand-new KitecomWP Framework[/smallheader]
		function kitecom_tss_small_header($atts, $content) {   
			// return the code
			return '<h2 class="gk-small-header">'.$content.'</h2>';    
		} 
		// add the shortcode to system
		add_shortcode('smallheader', 'kitecom_tss_small_header');
	}
	 ...
	 *
	 **/
	if(!function_exists('kitecom_tss_blue_btn')) {
		// Usage:
		// [bluebtn url="#"]View details[/bluebtn]
		function kitecom_tss_blue_btn($atts, $content) {   
			// extract the attributes
			extract(shortcode_atts(array("url" => "#"), $atts));
			// return the code
		...
		// add the shortcode to system
		add_shortcode('bluebtn', 'kitecom_tss_blue_btn');
	}
	 ...
	 *
	 **/
	if(!function_exists('kitecom_tss_yellow_btn')) {
		// Usage:
		// [yellowbtn url="#"]Download[/yellowbtn]
		function kitecom_tss_yellow_btn($atts, $content) {   
			// extract the attributes
			extract(shortcode_atts(array("url" => "#"), $atts));
			// return the code
		...
		// add the shortcode to system
		add_shortcode('yellowbtn', 'kitecom_tss_yellow_btn');
	}
