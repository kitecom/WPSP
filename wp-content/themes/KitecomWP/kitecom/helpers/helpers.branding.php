...
add_action('wp_head', 'kitecom_favicon');
...
if(!function_exists('kitecom_loginpage_url')) {
	function kitecom_loginpage_url() {
	 	return home_url();
	}
}

add_filter('login_headerurl', 'kitecom_loginpage_url');

if(!function_exists('kitecom_loginpage_title')) {
	function kitecom_loginpage_title() {
		return esc_attr(get_bloginfo('name'));
	}
} 

add_filter('login_headertitle', 'kitecom_loginpage_title');
...
if(!function_exists('kitecom_branding_custom_login_logo')) {

	function kitecom_branding_custom_login_logo() {
...
add_action('login_head', 'kitecom_branding_custom_login_logo');
...
if(!function_exists('kitecom_branding_custom_admin_logo')) {

	function kitecom_branding_custom_admin_logo() {
	   	// access to the template object
	   	global $tpl;
	   	// get logo path
	   	...
	   	if($logo_path !== '') {
		   echo '<style type="text/css">
	       		.wp-menu-image a[href="admin.php?page=kitecom-menu"] img {  
...
add_action('admin_head', 'kitecom_branding_custom_admin_logo');
